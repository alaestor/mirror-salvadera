...
validators.isInteger = fn({
    ...
    positional = true,
    parameters = { value = { __doc = [[any: the value to check]], required = true } },
...
validators.isBetween = fn({
    ...
    __doc_returns = [[boolean]],
    positional = true,
    parameters = { value = { __doc = [[any: the value to check]], required = true }, minimum = { __doc = [[number: the minimum value]], required = true }, maximum = { __doc = [[number: the maximum value]], required = true } },
...
validators.isSignedOffsetlike = fn({
    ...
    __doc_returns = [[boolean]],
    positional = true,
    parameters = { value = { __doc = [[any: the value to check]], required = true }, tooFarBoundary = { __doc = [[number: the boundary value]], default = nil } },
...
validators.isAddresslike = fn({
    ...
    __doc_returns = [[boolean]],
    positional = true,
    parameters = { value = { __doc = [[any: the value to check]], required = true }, nearNullBoundary = { __doc = [[number: the near-null boundary]], default = nil }, userspaceBoundary = { __doc = [[number: the userspace boundary]], default = nil } },
...
validators.hasFlag = fn({
    ...
    __doc_returns = [[boolean]],
    positional = true,
    parameters = { flag = { __doc = [[number: the flag to check for]], required = true }, flags = { __doc = [[number: the bit-flags to check]], required = true } },
...
validators.check = fn({
    ...
    __doc_returns = [[any]],
    positional = true,
    parameters = { value = { __doc = [[any: the value to check]], required = true }, checker = { __doc = [[any: the checker function]], default = nil } },
